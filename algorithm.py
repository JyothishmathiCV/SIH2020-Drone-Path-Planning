...
def create_data_model():
    ...
    charging_station=[data['distance_matrix'][0],data['distance_matrix'][13]]
    data["charging_station"]=charging_station
    del data["distance_matrix"][13]
    print("Matrixn\n")
    for i,j in enumerate(data['distance_matrix']):
        print(i,j)
    data['num_vehicles'] = 4
    ...
    for vehicle_id in range(data['num_vehicles']):
        ...
        while not routing.IsEnd(index):
            ...
            if ranged <= data["distance_matrix"][manager.IndexToNode(prev)][manager.IndexToNode(index)] + data["charging_station"][stationindex][manager.IndexToNode(index)]:
                ...
                ranged=1400-data["charging_station"][stationindex][manager.IndexToNode(index)]
